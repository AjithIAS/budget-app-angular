...
export class HomeComponent implements OnInit {
  ...
  // .../
  checkDate(date: Date) {
    // this.dateError = (this.budgetObj.date == null);
  }

  saveBudget(expenseForm: any) {
    // this.isLoading = true;
    if (typeof this.budgetObj.date !== 'string') {
      this.budgetObj.date = this.budgetObj.date.toDateString();
    }
    console.log(this.budgetObj)
    this.database.saveNewBudget(this.budgetObj, this.loginService.getUserId())
      .then((data) => {
        // this.isLoading = false;
        expenseForm.resetForm();
        // this.resetExpenseObj();
        this.openSnackBar("Budget Amount Saved")
        // this.announceChange();
      }).catch(e => {
      // this.isLoading = false;
